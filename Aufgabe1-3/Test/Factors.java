...
public final class Factors {
    ...
    // (Post): initializes growthFactor (between 0 and 1) and lossFactor (between 0 and 1) with the given values
    public Factors(double growthFactor, double lossFactor) {
        this.growthFactor = growthFactor;
        this.lossFactor = lossFactor;
    }

    // (Post): returns the growth factor stored in this instance (between 0 and 1)
    public double getGrowthFactor() {
        return growthFactor;
    }

    // (Post): returns the loss factor stored in this instance (between 0 and 1)
