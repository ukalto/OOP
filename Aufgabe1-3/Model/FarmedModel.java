...
public class FarmedModel extends BaseFarmingModel {
    ...
    //      which has additional impact on the population of the forest.
    ...
    //         n; also sets yearsWithoutHarvest to 0
    ...
    // (Post): updates the value of the harvest and the tree (age) population/structure
    ...
    //         and calculating the new proportions
