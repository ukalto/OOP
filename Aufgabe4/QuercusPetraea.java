public class QuercusPetraea implements Quercus, Domestic, LightDemanding {
    ...
    public QuercusPetraea(double size, double longitude, double latitude) {
        this.size = size;
    ...
    //         where >= 1 is stronger and <= 1 is weaker; the returned value == 1.2
    @Override
